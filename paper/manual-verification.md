...
| A04 | DOI | No DOI has been minted; the papers and `CITATION.cff` state this explicitly rather than carrying a placeholder | Mint through the selected repository/publisher and add the identifier to both papers and `CITATION.cff` | OPEN |
